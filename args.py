...
def get_args(description='Youtube-Text-Video'):
    ...
    parser.add_argument('--no_video', type=int, default=0,
                        help='no_video')
    parser.add_argument('--AV_T',type=int, default=0,
                        help='A+V then add T')
    parser.add_argument('--AT_V',type=int, default=0,
                        help='A+T then add V')
    parser.add_argument('--VT_A',type=int, default=0,
                        help='T+V then add A')
    parser.add_argument('--extra_text',type=int,default=0,
                        help='video and audio already leaned')
